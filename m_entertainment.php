...
if(isset($_POST['subject']) && isset($_POST['anonymous']) && isset($_POST['post'])){
	...
	$post->insertPost($_SESSION['user_ID'], "Entertainment", $_POST['subject'], $_POST['post'], $date, $_POST['anonymous'], $image);
}else{
...
<head>
<title>WomansBF (Entertainment)</title>
...
<form method = "post" action = "m_entertainment.php" enctype = "multipart/form-data">
<table>
	<tr>
		<td>Subject: </td>
...
<?php $post->getPostByCatMobile('Entertainment');?>
</div>
</body>
</html>