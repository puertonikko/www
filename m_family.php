...
if(isset($_POST['subject']) && isset($_POST['anonymous']) && isset($_POST['post'])){
	...
	$post->insertPost($_SESSION['user_ID'], "Family", $_POST['subject'], $_POST['post'], $date, $_POST['anonymous'], $image);
}else{
...
<form method = "post" action = "m_family.php" enctype = "multipart/form-data">
<table>
	<tr>
		<td>Subject: </td>
...
<?php $post->getPostByCatMobile('Family');?>
</div>
</body>
</html>